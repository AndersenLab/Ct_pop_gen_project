...
write.csv(Ct_isotype_list_Taiwan,
          "../../../processed_data/geo_info/Taiwan/Ct_isotype_list_Taiwan.csv",
          row.names = FALSE)

geo_Taiwan <- "../../../processed_data/geo_info/Taiwan/Ct_isotype_list_Taiwan.csv"
...
write.table(merged_data,
            "../../../processed_data/geo_info/Taiwan/Ct_TW_isotype_GIS.txt",
            quote = FALSE,
            sep = '\t',
            col.names = TRUE,
            row.names = FALSE)
