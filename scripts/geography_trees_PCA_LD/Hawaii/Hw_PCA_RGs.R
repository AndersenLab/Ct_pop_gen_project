...
GIS_data_raw<-read.table("../../../processed_data/geo_info/Hawaii/Ct_HW_isotype_GIS.txt",
                            sep = '\t',header = TRUE)
...
EVarNoRm_ld0.9 <- data.table::fread("../../../processed_data/geo_info/Hawaii/EIGESTRAT/LD_0.9/NO_REMOVAL/TracyWidom_statistics_no_removal.tsv") %>%
...
cdf9no <- data.table::fread("../../../processed_data/geo_info/Hawaii/EIGESTRAT/LD_0.9/NO_REMOVAL/eigenstrat_no_removal.evac", skip = 1)
...
saveRDS(cdf9_7no, file = "../../../processed_data/geo_info/Hawaii/cdf9_7no.rds")
...
saveRDS(PCA_main, file = "../../../processed_data/geo_info/Hawaii/Ct_PCA_Hawaii_RG.rds")
