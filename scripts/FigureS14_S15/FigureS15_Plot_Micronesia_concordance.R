...
target_lineage<-c("Mic1","Mic2")
target_geo<-"Micronesia"

target_isotype<-geo_and_lineage_Micro %>% 
...
dev.off()
pdf(paste0("../../plots/FigureS15_Ct_",target_isotype,"_concordance_heatmap_3.pdf"), width = 7, height = 6)
