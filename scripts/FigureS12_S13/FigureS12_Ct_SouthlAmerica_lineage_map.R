...
# South bounding box (same limits as your plot_South)
Southbox <- c(xmin = -85, ymin = -21, xmax = -37, ymax = 12)

# get world polygon for South
...
set.seed(123)
# compute boxed positions (reuse your findboxes settings; adjust maxiter / paddings if needed)
...
# join original coords with computed box coords
...
ggsave(South_pca_map1, 
       filename = "../../plots/FigureS12_Ct_South_map.pdf", 
       width = 7.5, 
       height = 7.5/48*33, 
       units = "in")
