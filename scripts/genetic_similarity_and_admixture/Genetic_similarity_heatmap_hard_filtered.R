...
col_idx <- ComplexHeatmap::column_order(p_heatmap_3)
...
## Relatedness group legend
grp_levels <- c(
  "LAC", 
  "Tw1", "Tw2", "Indo1", "Tw3", "Indo2","Tw4", 
  "Mic1", "Mic2",
  "HC", "Hw1", 
  "Tw5", "Au", "Tw6", 
  "Hw2", "Af", "Indo3","Tw7",
...
pdf("../../figures/raw_Figure2_Ct_all_sites_heatmap.pdf", 
    width = 12, height = 10)
