...
#SBATCH -N 1
#SBATCH -n 4
#SBATCH --output=zarr_to_pi_theta_d_nonHDRs_geo.oe
#SBATCH --job-name="ZPtdNonHDRGeo"


cd ../../processed_data
mkdir -p pi_theta_exclude_HDRs_geo
cd pi_theta_exclude_HDRs_geo

out_dir="../../../processed_data/pi_theta_exclude_HDRs_geo"
...
zarr="../../../processed_data/pi_theta_exclude_HDRs_geo/vcf_and_zarr"
