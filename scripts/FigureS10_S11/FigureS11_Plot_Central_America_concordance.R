...
target_lineage<-"LAC"
target_geo<-"Central America"

target_isotype<-geo_and_lineage_Cen %>% 
...
# 
# dev.off()
# pdf(paste0("../../plots/FigureS11_Ct_isotype_", target_isotype, "_concordance_heatmap.pdf"), width = 7, height = 6)
# 
...
dev.off()
pdf(paste0("../../plots/FigureS11_Ct_",target_isotype,"_concordance_heatmap_3.pdf"), width = 7, height = 6)
