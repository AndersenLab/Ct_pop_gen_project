...
# calculate Ne of C. elegans all 611 isotype reference strains 
...
# calculate Ne of C. elegans 111 isotype reference strains 
...
# calculate Ne of C. elegans 203 isotype reference strains 
...
# calculate Ne of C. briggsae 36 strains 
# according to Thomas's 2015 genome research paper, 10.1101/gr.187237.114
Ne_Cb <-calculate_Ne(input_file = "../processed_data/Cb_diversity/chromosome_windows_diversity.csv")
...
table_Ne_resultes <- data.frame(
  Samples = c("All", "Africa", "Australia","Caribbean","Central America",
             "Hawaii","South America","Taiwan","All_Ce","Big_island_Ce","Hawaii_Ce","Cb"),
  Ne_value = c(Ne_all, Ne_af, Ne_au,Ne_car,Ne_ca,
            Ne_hw,Ne_sa,Ne_tw,Ne_all_Ce,Ne_big_island_Ce,Ne_hw_Ce,Ne_Cb)
)
...
# Need LD data for Cb
ocRateSD_Cb<-calculate_ocRate(input_file = "../processed_data/Cb_diversity/LD/Cb_all.summary",
                                  Ne_value = Ne_Cb)
...
Region <- c("C_tropicalis_All", "C_tropicalis_Africa", "C_tropicalis_Australia", 
            "C_tropicalis_Caribbean", "C_tropicalis_Central_America", "C_tropicalis_Hawaii", 
            "C_tropicalis_South_America", "C_tropicalis_Taiwan","C_elegans_All",
            "C_elegans_Hawaii","C_briggsae")
